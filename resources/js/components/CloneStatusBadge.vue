<template>
  <span v-if="!project.git_remote" class="text-[10px] text-primary/30 uppercase tracking-tighter">No_Remote</span>
  ...
  <span
    v-else
    class="inline-flex items-center gap-1.5 text-[10px] text-primary/50 border border-primary/20 bg-black px-2 py-0.5 uppercase tracking-tighter"
  >
    Linked
  </span>
</template>
